        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 md:p-10 relative">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm leading-relaxed">
              By providing your phone number, you agree to receive a one-time text message from UDo for account verification. Message and data rates may apply. View our <a href="/privacy/" className="text-blue-600 font-medium hover:text-blue-800 transition">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </main>
